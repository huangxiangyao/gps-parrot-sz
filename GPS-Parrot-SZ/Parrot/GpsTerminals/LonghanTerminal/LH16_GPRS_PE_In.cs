...
namespace Parrot.Models.Longhan
{
    public class LH16_GPRS_PE_In
    {
        ...
        private void GetMobile_V(string _ID, byte[] body, ref MdtWrapper mobileInfo)
        {
            ...
            this.RecivEven(_ID, 2, "车载设备版本", str,  mobileInfo);
        }
        ...
        private void GetStatus(string _ID, byte[] body, ref MdtWrapper mobileInfo)
        {
            ...
            this.RecivEven(_ID, 2, "终端状态", str,  mobileInfo);
        }
        ...
        public void GprsDataIn_(string _ID, int Car_Type, byte[] body, ref MdtWrapper mobileInfo)
        {
            ...
            switch (body[2])
            {
                ...
                case 0x85:
                    ...
                    else
                    {
                        ...
                        this.CmdReport(_ID, body[body.Length - 7], 0, 0,  mobileInfo);
                    }
                    break;
                ...
                case 0x90:
                    {
                        ...
                        str5 = str5 + str6;
                        this.RecivEven(_ID, 2, "GPRS主机设置状态", str5,  mobileInfo);
                        goto Label_0913;
                    }
                case 0x91:
                    str5 = "";
                    if (!(((body[9] == 0xff) & (body[10] == 2)) & (body[12] == 0x30)))
                    {
                        if (body[9] == 4)
                        {
                            ...
                            this.RecivEven(_ID, 600, "抢答订单", str7,  mobileInfo);
                        }
                        if (body[9] == 5)
                        {
                            string str8 = Encoding.Default.GetString(body, 10, 13);
                            this.RecivEven(_ID, 600, "取消订单", str8,  mobileInfo);
                        }
                        if (body[9] == 6)
                        {
                            string str9 = Encoding.Default.GetString(body, 10, 13);
                            this.RecivEven(_ID, 600, "完成订单", str9,  mobileInfo);
                        }
                    }
                    else
                    {
                ...
                case 0xb2:
                    str5 = Encoding.Default.GetString(body, 9, ((body[3] * 3) + body[4]) - 6);
                    str5 = Convert.ToBase64String(Encoding.Default.GetBytes(str5));
                    this.RecivEven(_ID, 11, "主机版本", str5,  mobileInfo);
                    goto Label_0913;

                case 0xb3:
                    str5 = Encoding.Default.GetString(body, 9, ((body[3] * 3) + body[4]) - 6);
                    str5 = Convert.ToBase64String(Encoding.Default.GetBytes(str5));
                    this.RecivEven(_ID, 11, "主机工作状态", str5,  mobileInfo);
                    goto Label_0913;
            ...
            goto Label_0913;
        Label_038D:
            this.RecivEven(_ID, 2, "集团电话号码数据到手柄", str4,  mobileInfo);
            return;
        Label_0913:
            this.ReturnCmdByte[5] = body[body.Length - 2];
